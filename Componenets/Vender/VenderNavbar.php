...
if ($venderToken) {
  ...
  if ($vendor_id) {
    ...
    if ($vendor) {
      $name = $vendor['name'];
      $image = !empty($vendor['photo']) ? $vendor['photo'] : "./Image/default-user.png";
    }
  }
}
  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        <button onclick="openSideBar()" data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none ">
        ...
        <a href="/" class="flex ms-2 md:me-24">
          <span class="self-center text-xl text-gray-500 font-semibold sm:text-2xl whitespace-nowrap ml-4">SwiftCart</span>
        </a>
      </div>
