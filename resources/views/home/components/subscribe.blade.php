<section class="bg-[#f6f6f6] rounded-2xl max-w-7xl mx-auto p-6 md:p-12 flex flex-col md:flex-row items-center justify-between gap-10">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 6h14a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2z" />
      ...
      <input type="email" placeholder="Enter your Email" class="grow outline-none bg-transparent text-sm px-2" />
  ...
  <div data-aos="fade-left" class="md:w-1/2 hidden md:block">
    <div class="rounded-2xl overflow-hidden">
      <img src="{{ asset('images/Email.webp') }}" alt="Subscribe" class="bg-cover w-143 h-60.75 object-cover" />
    </div>
  </div>
</section>