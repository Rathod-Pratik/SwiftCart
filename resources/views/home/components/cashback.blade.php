<section class="px-4 py-10 sm:px-6 md:px-20 bg-gray-50 font-sans">
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <!-- Left Card -->
    <div data-aos="fade-right" class="relative rounded-2xl overflow-hidden min-h-87.5 flex items-center justify-start p-8 text-white bg-cover bg-center" style="background-image: url(\'/SwiftCart/Image/offer.png \');">
      <!-- Overlay -->
      <div class="absolute inset-0" style="background-image: url('{{ asset('images/OfferBackGround.webp') }}');"></div>
