...
@section('content')
   ...
   <section class="bg-white py-12 px-4 md:px-12 m-auto w-[80vw]">
    ...
    <div data-aos="fade-left" class="bg-[#2e5e5c] text-white p-8 rounded-2xl shadow-md w-full">
      ...
      <form class="space-y-5" id="ContactForm" method="POST">
        <div>
          ...
          <x-input type="text" name="name"  variant="contact"  />
        </div>
        <div>
          <label class="block mb-1 text-sm">Email Address</label>
          <x-input type="email" name="email"  variant="contact"  />
        </div>
        <div>
          <label class="block mb-1 text-sm">Phone Number</label>
          <x-input type="text" name="mobile"  variant="contact"  />
        </div>
        <div>
          <label class="block mb-1 text-sm">Messages</label>
          <textarea class="w-full px-4 py-2 rounded-md bg-[#3d6f6d] focus:outline-none" rows="4" name="message" ></textarea>
        </div>
