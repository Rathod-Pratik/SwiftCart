...
<section class="py-20  bg-[#e7f7f6]  relative overflow-hidden">
  ...
  <div class="max-w-6xl mx-auto px-6">
    <h2 class="text-4xl font-extrabold text-[#234445] text-center mb-14 ">Meet Our Team</h2>
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 justify-center">
      <!-- Member Card -->
      <div class="bg-white rounded-3xl shadow-2xl p-8 flex flex-col items-center text-center transition-transform hover:scale-105 hover:shadow-[#28afa2]/20 hover:border-[#28afa2] border border-transparent duration-300">
      ...
      <!-- Example: Add More Team Members Easily (optional) -->
      <!--
      <div class="bg-white rounded-3xl shadow-2xl p-8 flex flex-col items-center text-center transition-transform hover:scale-105 hover:shadow-[#28afa2]/20 hover:border-[#28afa2] border border-transparent duration-300">
        ... repeat pattern ...
      </div>
